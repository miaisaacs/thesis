...
genomic_track <- GeneRegionTrack(features_gr,
                                 ...
                                 fill = "lightblue",
                                 showId = TRUE)
probe_track <- DataTrack(probes_gr,
                         genome = "DENV",
                         chromosome = "DENV",
                         name = "Reactivity",
                         type = "p",
...
probe_axis <- GenomeAxisTrack(col = "red")
```

### plot all tracks together
```{r}
plotTracks(list(genome_axis, genomic_track, probe_track, probe_axis),
